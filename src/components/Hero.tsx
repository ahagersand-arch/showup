...
export const Hero = ({ src, alt, children }: Props) => {
  ...
  return (
    <section className="relative min-h-screen overflow-hidden">
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-b from-white/34 via-white/30 to-[#e8eef8]/72" />
      <div className="absolute inset-0 opacity-[0.12] [background-image:radial-gradient(rgba(30,41,59,0.2)_1px,transparent_1px)] [background-size:5px_5px]" />
